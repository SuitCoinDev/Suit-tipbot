...
class Withdraw:
    ...
    async def withdraw(self, ctx, address: str, amount: float):
        """Withdraw coins from your account to any Cryptonodes address"""
        ...
        if txid is None:
            ...
            await self.bot.say("{} **Withdrew {} CNMC! :money_with_wings:**\nView the transaction here: http://explorer.cryptonodes.ch/tx/{}".format(ctx.message.author.mention, str(amount), txid))
